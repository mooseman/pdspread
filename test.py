...
# TO DO - Look at maybe moving set_string and do_sheet out into a 
# separate class. Look at "breaking up" do_sheet. It would be good to 
# have something like the following - 
#   - a simple function to create a cell (a highlighted section of the 
#     screen)  
#   - a simple function to set the contents of the cell.  
#   - another function for formulas. This would be called if the first 
#     character in the cell was an equals sign ("=").  
