...
class cell(object): 
    ...
    def write(self, text, attr=None, align=None):                  
       ...
       if align == "left": 
          self.value = text.ljust(self.width)  
       elif align == "center": 
          self.value = text.center(self.width)    
       elif align == "right": 
          self.value = text.rjust(self.width)        
       ...
       if attr == None: 
          ...
          self.scr.addstr(self.y, self.x, str(self.value), attr)         
       # Clear self.value 
       self.value = ""             
       # Refresh the screen 
       self.scr.refresh()                                      
            
    def new_write(self, c):  
       c=chr(c)        
       self.value += c                 
       if str(self.value).isdigit() == "True":           
          self.value = self.value.rjust(self.width) 
       elif str(self.value).isdigit() == "False":              
          self.value = self.value.ljust(self.width) 
       # Get the position of the cursor. 
       (y, x) = self.scr.getyx()  
       self.y = y 
       self.x = x  
