...
def main(stdscr):
    ...
    screen.addstr(5, 4, "           This:", curses.A_BOLD)
    screen.addstr(8, 4, "             is:", curses.A_BOLD)
    screen.addstr(11, 4,"              a:", curses.A_BOLD)
    screen.addstr(14, 4,"         cuddly:", curses.A_BOLD)
    screen.addstr(17, 4,"          moose:", curses.A_BOLD)
