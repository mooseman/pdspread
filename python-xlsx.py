        ...
        for rowNode in sheetData.childNodes:
            ...
            for columnNode in rowNode.childNodes:
                ...
                if colType == "s":
                    ...
                    data =
columnNode.getElementsByTagName("v")[0].firstChild.nodeValue
                else:
                    data = ""
                if columnNode.getElementsByTagName("f"):
                    formula =
columnNode.getElementsByTagName("f")[0].firstChild.nodeValue
...
*Blog* <http://github.com/blog> | Support <http://support.github.com/> |
Training <http://github.com/training> | Contact
<http://github.com/contact> | API <http://develop.github.com> | Status
<http://twitter.com/github> | GitHub on Twitter
<http://twitter.com/github> | Help <http://github.com/guides/home>
GitHub™ is Logical Awesome <http://logicalawesome.com/> ©2009 | Terms of
Service </site/terms> | Privacy Policy </site/privacy>
